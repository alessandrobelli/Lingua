            ...
            <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
                ...
                <div class="modal-content py-4 text-left px-6">
                    ...
                    <div class="flex justify-end pt-2">
                        ...
                        @if($entityToDelete === "merge translations")
                            <button class="modal-close px-4 bg-red-600 p-3 rounded-lg text-white hover:bg-red-400 " wire:click="delete()">Merge</button>

                        @else
                            <button class="modal-close px-4 bg-red-600 p-3 rounded-lg text-white hover:bg-red-400 " wire:click="delete()">Delete</button>
